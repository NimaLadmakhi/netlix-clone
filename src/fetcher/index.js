...
export const ListLoadDB_URL = (id) =>
     `https://api.themoviedb.org/3/list/${id}?api_key=${API_TOKEN}`;
...
export const MovieDB_URL = (id) =>
     `https://api.themoviedb.org/3/movie/${id}/videos?api_key=${API_TOKEN}`;
export const ImageDB_URL = (src) =>
     `https://image.tmdb.org/t/p/original/${src}?api_key=${API_TOKEN}`;
